// =======================================================================================
// /////////////////////////Padawan360 Body Code - Mega I2C v2.1 /////////////////////////
// =======================================================================================
/*
by Dan Kraus
dskraus@gmail.com
...
v2.1 Changes:
- Update HoloProjector commands to work with CuriousMarc updated REON HP firmware.
- Andrew Beaton https://github.com/andrewbeaton/R2D2/
- June 2021
...
void loop() {
  ...
  if (Xbox.getButtonClick(A, 0)) {
    if (Xbox.getButtonPress(L1, 0)) {
      ...
      // Logic lights.
      triggerI2C(10, 6);
      // HP Event 14 - SystemFailure. 
      // Note: Will cause unresponsiveness until event finished.
      triggerI2C(25, 14);
      triggerI2C(26, 14);
      triggerI2C(27, 14);
    } else if (Xbox.getButtonPress(L2, 0)) {
  ...
  if (Xbox.getButtonClick(B, 0)) {
    if (Xbox.getButtonPress(L1, 0)) {
      ...
      mp3Trigger.play(10);
      // Logic lights bar graph.
      triggerI2C(10, 10);
      // HP Event 3 - Always On, Random Colour.
      triggerI2C(25, 3);
      triggerI2C(26, 3);
      triggerI2C(27, 3);
    } else {
  ...
  if (Xbox.getButtonClick(hpLightToggleButton, 0))  {
    ...
    if (isHPOn) {
      isHPOn = false;
      // Turn HP light off.
      // Front HP Event 1 - Off.
      triggerI2C(25, 1);
    } else {
      isHPOn = true;
      // Turn HP light on.
      // Front HP Event 2 - White (All LEDs On).
      triggerI2C(25, 2);
    }
  }
